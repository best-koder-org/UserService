...
namespace UserService.Migrations
{
    ...
    [Migration("20260907145038_AddIsFakeProfile")]
    partial class AddIsFakeProfile
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserService.Models.AppVersionReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppVersionReports");
                });

            modelBuilder.Entity("UserService.Models.Entitlement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UserService.Models.PsykologMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PsykologMessages");
                });

            modelBuilder.Entity("UserService.Models.PsykologSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("WeakestAxesJson")
                        .HasColumnType("longtext");
                    ...
                    b.ToTable("PsykologSessions");
                });

            modelBuilder.Entity("UserService.Models.ReflectionVector", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UserService.Models.SparksLedgerEntry", b =>
                {
                    ...
                    b.ToTable("SparksLedger");
                });

            modelBuilder.Entity("UserService.Models.SupportTicket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UserService.Models.UserTheme", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UserService.Models.PsykologMessage", b =>
                {
                    b.HasOne("UserService.Models.PsykologSession", "Session")
                        .WithMany("Messages")
